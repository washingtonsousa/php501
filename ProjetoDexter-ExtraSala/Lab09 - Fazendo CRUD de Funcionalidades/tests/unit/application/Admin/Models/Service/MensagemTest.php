...
class MensagemTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testShouldGetDefaultMensagemMapper()
    {
        $this->assertInstanceOf(
            '\\DexterApp\\Admin\\Models\\DataMapper\\Mensagem',
    ...
    public function testShouldInsert()
    {
        ...
        $mapperMock = $this->getMock('\\DexterApp\\Admin\\Models\\DataMapper\\Mensagem');
        $mapperMock->expects($this->once())
            ->method('insert')
            ->with($this->equalTo(new \DexterApp\Admin\Models\Entity\Mensagem($dados)));
    ...
    public function testShouldgetMensagem()
    {
        ...
        $this->assertEquals(new \DexterApp\Admin\Models\Entity\Mensagem($dados), $result);
    }
}
