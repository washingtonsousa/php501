...
class ClienteTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testShouldGetDefaultClienteMapper()
    {
        $this->assertInstanceOf(
            '\\DexterApp\\Admin\\Models\\DataMapper\\Cliente',
    ...
    public function testShouldInsert()
    {
        ...
        $mapperMock = $this->getMock('\\DexterApp\\Admin\\Models\\DataMapper\\Cliente');
        $mapperMock->expects($this->once())
            ->method('insert')
            ->with($this->equalTo(new \DexterApp\Admin\Models\Entity\Cliente($dados)));
    ...
    public function testShouldGetCliente()
    {
        ...
        $this->assertEquals(new \DexterApp\Admin\Models\Entity\Cliente($dados), $result);
    }
}
