...
class DestaqueTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testShouldGetDefaultDestaqueMapper()
    {
        $this->assertInstanceOf(
            '\\DexterApp\\Admin\\Models\\DataMapper\\Destaque',
    ...
    public function testShouldInsert()
    {
        ...
        $mapperMock = $this->getMock('\\DexterApp\\Admin\\Models\\DataMapper\\Destaque');
        $mapperMock->expects($this->once())
            ->method('insert')
            ->with($this->equalTo(new \DexterApp\Admin\Models\Entity\Destaque($dados)));
    ...
    public function testShouldGetDestaque()
    {
        ...
        $this->assertEquals(new \DexterApp\Admin\Models\Entity\Destaque($dados), $result);
    }
}
