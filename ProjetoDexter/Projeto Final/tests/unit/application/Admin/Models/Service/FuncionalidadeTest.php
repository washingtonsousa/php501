...
class FuncionalidadeTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testShouldGetDefaultFuncionalidadeMapper()
    {
        $this->assertInstanceOf(
            '\\DexterApp\\Admin\\Models\\DataMapper\\Funcionalidade',
    ...
    public function testShouldInsert()
    {
        ...
        $mapperMock = $this->getMock('\\DexterApp\\Admin\\Models\\DataMapper\\Funcionalidade');
        $mapperMock->expects($this->once())
            ->method('insert')
            ->with($this->equalTo(new \DexterApp\Admin\Models\Entity\Funcionalidade($dados)));
    ...
    public function testShouldGetFuncionalidade()
    {
        ...
        $this->assertEquals(new \DexterApp\Admin\Models\Entity\Funcionalidade($dados), $result);
    }
}
